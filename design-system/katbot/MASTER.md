...
**Color Notes:** Auto palette is dark tech. **Monitor UI does not use it.** See `design-system/katbot/pages/monitor.md` (pastel glassmorphism: Be Vietnam Pro + Inter, blush/sky/mint blobs, frosted cards).
